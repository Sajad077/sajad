      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/sajooo9o/27",
                   'caption'=>'التفعيل بواسطة : sjo211
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب 👨🏻‍💻','callback_data'=>'login']],
                       [['text'=>"LUCIFER", 'url'=>"@sjo211"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/help'){
              ...
              'video'=>"https://t.me/sajooo9o/27",
              'caption'=>'طرق السحبب🤘😂',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝙍𝙚𝙥𝙤𝙧𝙩 𝙋𝙧𝙤𝙗𝙡𝙚𝙢𝙨", 'url'=>"https://t.me/sjo211]],
                       ]
                       ])
                       ]);
    
              $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/sajooo9o/57",
                           'caption'=>'الصيد تضمن كيف😂🤘',
                ]);
                      $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/sajooo9o/27",
